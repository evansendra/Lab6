...
public class YahooStockQuoteHTMLQuoteExtractor implements
	...
	public StockQuoteInterface getCurrentQuote() throws Exception {
		String quoteURL = "http://download.finance.yahoo.com/d/quotes.csv?s="
				+ this.symbol + "&f=sl1d1t1c1ohgv&e=.csv";
		...
		try {
			...
			retVal = new StockQuote(fields[YahooStockQuoteHTMLQuoteExtractor.SYMBOL], "TBD",
					Double.parseDouble(fields[YahooStockQuoteHTMLQuoteExtractor.LASTTRADE]), Double
							.parseDouble(fields[YahooStockQuoteHTMLQuoteExtractor.OPEN]));
